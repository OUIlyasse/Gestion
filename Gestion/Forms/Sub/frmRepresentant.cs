    ...
    public partial class frmRepresentant : frmCRUD
    {
        ...
        public override void Add_Data()
        {
            try
            {
                ...
                switch (rs)
                {
                    ...
                    case 2:
                        iMessage.sucMsg("Information", "Votre representant a bien ajouté");
                        base.Add_Data();
                        Verify_Buttons(true);
                        break;
                }
        ...
        public override void Update_Data()
        {
            try
            {
                ...
                switch (rs)
                {
                    ...
                    case 2:
                        iMessage.sucMsg("Information", "Votre representant a bien modifié");
                        base.Update_Data();
                        Verify_Buttons(true);
                        break;
                }
        ...
        public override void Delete_Data()
        {
            ...
            if (re == DialogResult.Yes)
            {
                try
                {
                    db.Delete_Representant(idRepresentant);
                    iMessage.sucMsg("Information", "Ce representant  a bien supprimé");
                    base.Delete_Data();
                    Verify_Buttons(true);
                }
                catch (Exception ex)
        ...
        private void Control_Validating(object sender, CancelEventArgs e)
        {
            if (sender is RichTextBox)
            {
                ...
                {
                    case "txtObservation":
                        txtObservation.Text = iText.ValidateText(txtObservation.Text, TypeText.Defaut); break;
                }
            }
            else if (sender is TextBox)
            {
                ...
                {
                    case "txtPrenom":
                        txtPrenom.Text = iText.ValidateText(txtPrenom.Text, TypeText.Defaut); break;

                    case "txtNom":
                        txtNom.Text = iText.ValidateText(txtNom.Text, TypeText.Majuscule); break;

                    case "txtCin":
                        txtCin.Text = iText.ValidateText(txtCin.Text, TypeText.Majuscule); break;

                    case "txtGsm":
                        txtGsm.Text = iText.ValidateText(txtGsm.Text, TypeText.Defaut); break;
                }
            }
        }
